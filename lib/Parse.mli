...
(**
    Functions for parsing kotlin programs into a CST.

    Generated by ocaml-tree-sitter.
*)

(** Parse a kotlin program from a string into a typed OCaml CST.
...
(** Parse a kotlin program from a file into a typed OCaml CST.
